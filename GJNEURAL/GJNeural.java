...
public class GJNeural {
	...
	public static class Organism{
		...
		public Organism(int no_input,int[] no_node,int no_layer,int no_output,float learningrate){
			...
			System.out.println(no_layer);
			for(int i=0;i<no_layer;i++){
				layers[i] = new Layer(no_node[i],i);
			}
			
			output_layer = new Layer(no_output,no_layer);
			this.neuralnetwork = new NeuralNetwork(input_layer,layers,output_layer,learningrate);
	...
	public static class NeuralNetwork{
		...
		float time=10;
		public NeuralNetwork(Input_Layer input_layer,Layer[] layers,Layer output_layer,float learningrate){
			this.layers = layers;
		...
		public void Initialize_Network(){
			input_layer.network = this;
			for(int i=0;i<layers.length;i++){
				layers[i].network = this;
				if(i==0){
